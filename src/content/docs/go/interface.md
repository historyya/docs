...
func Use(usb USB) {
	...
	// switch obj := usb.(type) {
	// case Apple:
	// 	fmt.Println("Apple", obj.City)
	// case Samsung:
	// 	fmt.Println("Samsung", obj.Address)
	// default:
	// 	fmt.Println("Unknown")
	// }
